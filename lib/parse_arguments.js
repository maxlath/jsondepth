...
var [ argsString, formatAsJson, jsonIndentation ] = getJsonIndentation(rawArgs)

const lineArgPattern = /\s?(--line|-l)\s?/
const lineByLine = argsString.match(lineArgPattern) != null
argsString = argsString.replace(lineArgPattern, ' ').trim()
